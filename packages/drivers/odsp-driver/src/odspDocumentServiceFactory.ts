...
export function createOdspDocumentServiceFactory(
	...
	class ConfiguredOdspDocumentServiceFactory extends OdspDocumentServiceFactory {
		...
		public override readonly createPointInTimeAvailabilityProvider:
			| PointInTimeAvailabilityDocumentServiceFactory["createPointInTimeAvailabilityProvider"]
			| undefined =
			pointInTimeAvailabilityImplementation === undefined
				? undefined
				: async (resolvedUrl, logger, clientIsSummarizer) =>
